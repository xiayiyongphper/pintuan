...
/**
 * CreateOrderProductsRes message
 */
class CreateOrderProductsRes extends \framework\protocolbuffers\Message
{
    ...
    protected static $fields = array(
        self::items => array(
            'name' => 'items',
            'repeated' => true,
            'type' => '\message\product\CreateOrderItem'
        ),
     ...
     *
     * @param \message\product\CreateOrderItem $value Value to append
     *
     * @return null
     */
    public function appendItems(\message\product\CreateOrderItem $value)
    {
     ...
     * Returns 'items' list
     *
     * @return \message\product\CreateOrderItem[]
     */
