 ...
 * BuyItemsReq message
 */
class BuyItemsReq extends \framework\protocolbuffers\Message
{
     ...
     *
     * @param \message\product\BuyItem $value Value to append
     *
     * @return null
     */
    public function appendItems(\message\product\BuyItem $value)
    {
     ...
     * Returns 'items' list
     *
     * @return \message\product\BuyItem[]
     */
