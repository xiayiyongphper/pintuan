...
/**
 * OrderReviewProductsRes message
 */
class OrderReviewProductsRes extends \framework\protocolbuffers\Message
{
    ...
    protected static $fields = array(
        self::items => array(
            'name' => 'items',
            'repeated' => true,
            'type' => '\message\product\OrderReviewItem'
        ),
     ...
     *
     * @param \message\product\OrderReviewItem $value Value to append
     *
     * @return null
     */
    public function appendItems(\message\product\OrderReviewItem $value)
    {
     ...
     * Returns 'items' list
     *
     * @return \message\product\OrderReviewItem[]
     */
