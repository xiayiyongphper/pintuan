...
/**
 * CreateOrderItem message
 */
class CreateOrderItem extends \framework\protocolbuffers\Message
{
    ...
    const images = 5;
    const description = 6;
    const third_category_id = 7;
    const item_detail = 8;
    const purchase_price = 9;
    const pick_commission = 10;
    const promote_commission = 11;
    const pintuan_price = 12;
    const specification_id = 13;
    const pintuan_id = 14;
    const product_num = 15;
