...
/**
 * RawProductRes message
 */
class RawProductRes extends \framework\protocolbuffers\Message
{
    ...
    protected static $fields = array(
        self::items => array(
            'name' => 'items',
            'repeated' => true,
            'type' => '\message\product\RawProductItem'
        ),
     ...
     *
     * @param \message\product\RawProductItem $value Value to append
     *
     * @return null
     */
    public function appendItems(\message\product\RawProductItem $value)
    {
     ...
     * Returns 'items' list
     *
     * @return \message\product\RawProductItem[]
     */
