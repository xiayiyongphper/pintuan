...
/**
 * RawProductReq message
 */
class RawProductReq extends \framework\protocolbuffers\Message
{
    ...
    protected static $fields = array(
        self::items => array(
            'name' => 'items',
            'repeated' => true,
            'type' => '\message\product\RawBuyItem'
        ),
     ...
     *
     * @param \message\product\RawBuyItem $value Value to append
     *
     * @return null
     */
    public function appendItems(\message\product\RawBuyItem $value)
    {
     ...
     * Returns 'items' list
     *
     * @return \message\product\RawBuyItem[]
     */
