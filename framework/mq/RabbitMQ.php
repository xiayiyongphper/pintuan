...
class RabbitMQ extends Component
{
    ...
    public function __construct($config = [])
    {
        ...
        if (!$this->channel) {
            try {
                ToolsAbstract::log($this->host, 'RabbitMQ.log');
                ToolsAbstract::log($this->port, 'RabbitMQ.log');
                ToolsAbstract::log($this->user, 'RabbitMQ.log');
                ToolsAbstract::log($this->password, 'RabbitMQ.log');
                ToolsAbstract::log(ENV_RABBITMQ_VHOST, 'RabbitMQ.log');
