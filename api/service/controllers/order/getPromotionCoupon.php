...
use service\callService\order\getPromotionCouponProxy;
use service\callService\order\getShareCouponCountProxy;

/**
 * Class orderList
 */
class getPromotionCoupon extends ApiAbstract
{
    public function run($params)
    {
        ...
        //判断可领优惠券数量
        $result = (new getPromotionCouponProxy($request))->sendRequest()->toArray();
