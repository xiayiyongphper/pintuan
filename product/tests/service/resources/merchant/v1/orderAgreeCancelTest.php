...
use service\resources\merchant\v1\orderAgreeCancel;
use tests\service\ApplicationTest;

class orderAgreeCancelTest extends ApplicationTest
{
    public function getModel()
    {
        return new orderAgreeCancel();
    }

    public function testModel()
    {
        $this->assertInstanceOf('service\resources\merchant\v1\orderAgreeCancel', $this->model);
    }

    public function testRequest()
    {
        $this->assertInstanceOf('service\message\common\OrderAction', orderAgreeCancel::request());
    }

    public function testResponse()
    {
        $this->assertInstanceOf('service\message\common\Order', orderAgreeCancel::response());
    }
	...
	public function testRun()
	{
		...
		$this->assertEquals('canceled', $data->getStatus());
	...
	public function testOrderCantAgreeCancel()
	{
		// 把订单置为已拒单
		$order_id = 234381;
		$order = SalesFlatOrder::findOne(['entity_id'=>$order_id]);
		...
		/** @var \service\message\common\Order $data*/
		list($header, $data) = $response;
		$this->assertEquals(8203, $header->getCode());
