...
class addCollectTest extends ApplicationTest
{
    public function getModel()
    {
        return new addCollect();
    }

    public function testModel()
    {
        $this->assertInstanceOf('service\resources\merchant\v1\addCollect', $this->model);
    }

    public function testRequest()
    {
        $this->assertInstanceOf('service\message\merchant\wishlistRequest', addCollect::request());
    }

    public function testResponse()
    {
        $this->assertTrue(addCollect::response());
    }
	...
	public function testRun()
	{
		...
		$this->header->setRoute('merchant.addCollect');
