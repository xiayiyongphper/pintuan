...
<form class="layui-form" action="" method="post">
    ...
    <table class="layui-table" style="margin: 0;">
        ...
        <tr id="zitidian_box" style="display: none;">
            <td width="10%">
                活动自提点
            </td>
            <td colspan="3">
...
<script>
    ...
    function getGoods(data)
    {
        ...
        if (dataList) {
            var priceInput = '<td><input type="text" name="prices[]" lay-verify="required|number" maxlength="10" autocomplete="off" placeholder="0.00" class="layui-input"></td>';
