...
<style>
    ...
    <form class="layui-form">
        <div class="layui-inline" style="margin-left: 20px;">
            <button type="button" id="addbtn" class="layui-btn layui-btn-danger"><i class="layui-icon">&#xe608;</i>创建店铺佣金类型</button>
        </div>
    </form>
...
<script>
    var get_url = "<?php echo \yii\helpers\Url::toRoute(['commission/getlist']) ?>";
    var detail_url = "<?php echo \yii\helpers\Url::toRoute(['commission/update']) ?>";
    var createUrl = "<?php echo \yii\helpers\Url::toRoute(['commission/create']);?>";
    ...
    function del(obj)
    {
        ...
        var delUrl = "<?php echo \yii\helpers\Url::toRoute(['commission/del']);?>";
    ...
    layui.use(['table','form'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'name', title: '佣金类型名称', width:350}
