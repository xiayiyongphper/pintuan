...
<table class="layui-table" id="pintuan_good_table"></table>
<script src="http://libs.baidu.com/jquery/2.1.1/jquery.min.js"></script>
<script src="../../layui/layui.js"></script>
<script>
   var url = "<?php echo \yii\helpers\Url::toRoute(['choose/getpintuanproducts']) ?>";
    layui.use(['table'], function(){
        var table = layui.table;
        //方法级渲染
        table.render({
            elem: '#pintuan_good_table'
            ,url: url
            ,cols: [[
                ...
                ,{field:'item_detail', title: '商品规格'}
            ]]
            ,id: 'pintuan_good_table'
            ,page: true
            ,limit : 10
            ,width:1300
        });
        ...
        var $ = layui.$, active = {
            reload: function(){
                ...
                var actId = $('#actId').val();
                table.reload('pintuan_good_table', {
                    page: {
                        curr: 1 //重新从第 1 页开始
                    }
                    ,where: {
            ...
            getCheckData: function(){ //获取选中数据
                var checkStatus = table.checkStatus('pintuan_good_table')
