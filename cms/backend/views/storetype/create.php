...
<form class="layui-form" action="" method="post">
    ...
    <table class="layui-table" style="margin: 0;">
        <tr>
            <td width="15%">店铺类型名称</td>
            <td>
                <input type="text" name="name" lay-verify="required" maxlength="30" autocomplete="off" placeholder="请输入店铺类型名称" class="layui-input">
            </td>
        </tr>
        <tr>
            <td width="15%">佣金类型</td>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="commission_val" lay-verify="required|number" maxlength="3" style="width: 150px;display: inline-block;margin-right: 10px;" autocomplete="off" placeholder="请输入佣金数值" class="layui-input">
                <span id="commission_val_msg">%</span>
            </td>
        </tr>
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(submit)', function(data){
            var url = "<?php echo \yii\helpers\Url::toRoute(['storetype/add']);?>";
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.code == 0) {
                        var index_url = "<?php echo \yii\helpers\Url::toRoute(['storetype/index']);?>";
