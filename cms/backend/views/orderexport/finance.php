...
<form id="myform" action="exportfinance" method="get">
<table class="table table-bordered">
    <tr class="warning"><td colspan="2" style="color:blue;font-size: 16px;">
            温馨提示
        </td></tr>
    <tr class="success"><td colspan="2" style="color:blue;font-size: 16px;">1、导出财务核对单据<br/>2、导出规则：【已支付、已发货、已到货、已确认收货、已取消 + 尚未删除】的订单<br/>3、导出过程中，请您耐心等待！若数据过大无法导出，请按单个供货商导出！</td></tr>
...
<?php
$url = \yii\helpers\Url::toRoute('/orderexport/exportfinance');
?>
