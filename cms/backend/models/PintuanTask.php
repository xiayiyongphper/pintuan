 ...
 * @property string $pintuan_end_autoadd_time 拼团结束自动处理时间
...
class PintuanTask extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['pintuan_activity_id', 'pintuan_id', 'pintuan_members', 'continue_pintuan', 'base_members', 'system_autoadd_members', 'promise_group', 'base_members_aftertime_active', 'system_autoadd_endtime_nums', 'del', 'promise_group_type', 'system_autoadd_type', 'base_members_type', 'status'], 'integer'],
            [['pintuan_activity_starttime','pintuan_end_autoadd_time', 'pintuan_activity_endtime', 'create_at', 'update_at'], 'safe'],
            [['base_members_aftertime','pintuan_end_autoadd_time', 'system_autoadd_endtime', 'promise_group_endtime'], 'string', 'max' => 30],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'pintuan_end_autoadd_time' => 'pintuan_end_autoadd_time',
